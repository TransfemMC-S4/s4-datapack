...
#Message contents
execute if score message dingtimer matches 1 run tellraw @a ["",{color:"white",text:"日 "},{color:"#9c80d3",text:"Check out Quinn's final song of the week!"},"\n",{color:"#A2D2FF",underlined:true,text:"\"",extra:[{bold:true,score:{name:"song",objective:"dingtimer"}},"\" - ",{bold:true,score:{name:"artist",objective:"dingtimer"}}]}]
...
execute if score message dingtimer matches 3 run tellraw @a ["",{color:"white",text:"日 "},{color:"#A2D2FF",text:"Thank you for playing season three!"}]
